...
export class UsuarioService {
  private apiUrl = 'https://backend-biblioteca-main-ishs.onrender.com/api/usuarios';

  private healthUrl = 'https://backend-biblioteca-main-ishs.onrender.com/api/health';
